...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.compontConfig = this.compontConfig.bind(this);
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.itemToEdit).length > 0) {
            ...
            this.setState({
                ...
                category: category || "HC",
                position: position || "",
                url: url || "",
                editMode: true,
                apiUrl: `https://brikozub.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
            ...
            >
                ...
                <div className="two-column">
                    ...
                    <select
                        ...
                        onChange={this.handleChange}
                    >
                        <option value="HCJ">Select Category</option>
